...
export default function CardRejectedData() {
  ...
  useEffect(() => {
    const fetchAlldata = async () => {
      ...
      let data = await fetch(
        `https://api.addrupee.com/api/card_rejected-data/${email}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
