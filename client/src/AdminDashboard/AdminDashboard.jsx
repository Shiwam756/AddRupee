...
function AdminDashboard() {
  ...
  const fetchAlldata = async () => {
    try {
      let data = await fetch(
        `http://localhost:5000/api/fetchAdminAlldata?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
  ...
  const fetchPendingData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getpendingadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchApprovedData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getdisbursedadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchRejectedData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getrejectedadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardAlldata = async () => {
    try {
      let data = await fetch(
        `http://localhost:5000/api/fetchCardAdminAlldata?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardPendingData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getCardpendingadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardApprovedData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getCarddisbursedadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchCardRejectedData = async () => {
    ...
    try {
      let data = await fetch(
        `http://localhost:5000/api/getCardrejectedadmindatas/${Status}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
