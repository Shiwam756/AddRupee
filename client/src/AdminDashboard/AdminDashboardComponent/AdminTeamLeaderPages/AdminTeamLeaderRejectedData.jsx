...
export default function AdminTeamLeaderRejectedData() {
  ...
  const handleRejectedTlDelete = async (_id) => {
    ...
    try {
      // Send a DELETE request to the backend to delete the rejected data
      const response = await fetch(
        `http://localhost:5000/api/deletetlrejectedData/${_id}`,
        {
          method: "DELETE",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
