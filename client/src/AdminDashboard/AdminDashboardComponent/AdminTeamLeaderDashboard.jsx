...
const AdminTeamLeaderDashboard = () => {
    ...
    const fetchData = async () => {
      try {
        let data = await fetch(
          `http://localhost:5000/api/fetchAlldata/${Tl_Name}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
          {
            method: "GET",
            credentials: "include",
  ...
  const fetchPendingData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/getpendingtldatas/${Tl_Name}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchRejectedData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/getrejectedtldatas/${Tl_Name}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
