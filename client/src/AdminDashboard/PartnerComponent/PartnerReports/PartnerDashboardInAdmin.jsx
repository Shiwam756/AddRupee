      ...
      <div className="grid-container">
        ...
        <main className="main-container">
          <div className="main-title">
            <h3 className="fs-3 text-dark ">{`${Partner_Name}'s Dashboard`}</h3>
          </div>
...
export default PartnerDashboardInAdmin;
