...
const CareerFrom = () => {
  const [formData, setFormData] = useState({
    ...
    Upload_Cibil: null,
    experience: "",
    experiene_year: "", // New field for year of experience
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://api.addrupee.com/api/career_form", {
        method: "POST",
  ...
  const handleExperienceChange = (e) => {
    ...
    // Update the state with the selected experience value
    setFormData((prevFormData) => ({
      ...prevFormData,
      experience: value,
    }));
      ...
      <form className="container" onSubmit={handleSubmit}>
        ...
        <div className="row">
          ...
          {formData.experience === "Experienced" && (
            <div className="col-12 col-xl-4 col-md-4 mb-3">
              <label htmlFor="experiene_year" className="form-label">
                Year of Experience*
              </label>
              <input
                type="text"
