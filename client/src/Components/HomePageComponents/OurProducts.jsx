...
import GeneralInsurance from "../../assets/General Insurance.jpg";
      ...
      <section style={{ backgroundColor: "#EEECED" }} className="py-3">
        <div className="container">
          ...
          >
            ...
            <div className="card ourProducts_card">
              <img src={HealthInsurance} className="card-img-top" alt="..." />
              <div className="card-body">
                ...
                <Link to={"/health-insurance"} className="btn btn-success">
                  Read More
                </Link>
              </div>
            </div>
            ...
            <div className="card ourProducts_card">
              <img src={GeneralInsurance} className="card-img-top" alt="..." />
              <div className="card-body">
                ...
                <Link to={"/general-insurance"} className="btn btn-success">
                  Read More
                </Link>
              </div>
            </div>
            ...
            <div className="card ourProducts_card">
              <img src={LifeInsurance} className="card-img-top" alt="..." />
              <div className="card-body">
