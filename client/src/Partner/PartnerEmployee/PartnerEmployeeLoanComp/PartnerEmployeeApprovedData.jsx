...
export default function PartnerEmployeeApprovedData() {
  ...
  useEffect(() => {
    const fetchAlldata = async () => {
      ...
      let data = await fetch(
        `http://localhost:5000/api/p_approved-data/${email}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
        {
          method: "GET",
          credentials: "include",
