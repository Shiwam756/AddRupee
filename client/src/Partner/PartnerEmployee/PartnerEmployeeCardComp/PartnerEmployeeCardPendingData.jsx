...
export default function PartnerEmployeeCardPendingData() {
  ...
  const fetchAlldata = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_card_getpendingdatas/${email}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
