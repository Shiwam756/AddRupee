...
import Header from "./PartnerEmployeeHeader";
import Sidebar from "./PartnerEmployeeSidebar";

function PartnerEmployeeDashboard() {
  ...
  const fetchAlldata = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_pendingdata/${email}?filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
  ...
  const fetchPendingData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_getpendingdatas/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchApprovedData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_approved-data/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchRejectedData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_rejected-data/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardAlldata = async () => {
    console.log("this is email", email);
    let data = await fetch(
      `http://localhost:5000/api/p_card_pendingdata/${email}?filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardPendingData = async () => {
    ...
    let data = await fetch(
      `http://localhost:5000/api/p_card_getpendingdatas/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardApprovedData = async () => {
    const Status = "Disbursed";
    let data = await fetch(
      `http://localhost:5000/api/p_card_approved-data/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardRejectedData = async () => {
    const Status = "Rejected";
    let data = await fetch(
      `http://localhost:5000/api/p_card_rejected-data/${email}?Status=${Status}&filter=${selectedFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
    ...
    <div className="grid-container">
      ...
      <main className="main-container">
        ...
        <div className="main-cards">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_employee_pending">
              <div className="card-inner">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_employee_approved">
              <div className="card-inner">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_employee_rejected">
              <div className="card-inner">
...
export default PartnerEmployeeDashboard;
