...
import Header from "./PartnerTlHeader";
import Sidebar from "./PartnerTlSidebar";

function PTlDashboard() {
  ...
  useEffect(() => {
    const fetchCardData = async () => {
      try {
        let data = await fetch(
          `http://localhost:5000/api/p_card_fetchAlldata/${Tl_Name}?filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
          {
            method: "GET",
            credentials: "include",
            headers: { "Content-Type": "application/json" },
  ...
  const fetchCardPendingData = async () => {
    const Status = "Pending";
    let data = await fetch(
      `http://localhost:5000/api/p_card_getpendingtldatas/${Tl_Name}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardApprovedData = async () => {
    const Status = "Disbursed";
    let data = await fetch(
      `http://localhost:5000/api/p_card_getdisbursedtldatas/${Tl_Name}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
  ...
  const fetchCardRejectedData = async () => {
    const Status = "Rejected";
    let data = await fetch(
      `http://localhost:5000/api/p_card_getrejectedtldatas/${Tl_Name}?Status=${Status}&filter=${selectedFilter}&bankFilter=${selectedBankFilter}`,
      {
        method: "GET",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
    ...
    <div className="grid-container">
      ...
      <main className="main-container">
        ...
        <div className="main-cards">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_loan_pending">
              <div className="card-inner">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_loan_approved">
              <div className="card-inner">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_loan_rejected">
              <div className="card-inner">
        ...
        <div className="main-cards">
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_card_pending">
              <div className="card-inner">
                <h3 className="fs-5 fs-bold p-3 text-white">PENDING</h3>
                <BsFillGrid3X3GapFill
                  className="card_icon"
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_card_approved">
              <div className="card-inner">
                <h3 className="fs-5 fs-bold p-3 text-white">DISBURSED</h3>
                <BsPeopleFill
                  className="card_icon"
          ...
          <div className="dash_card">
            <Link style={{ textDecoration: "none" }} to="/p_tl_card_rejected">
              <div className="card-inner">
                <h3 className="fs-5 fs-bold p-3 text-white">REJECTED</h3>
                <BsFillBellFill
                  className="card_icon"
