...
const PartnerTlCardAddLeadForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(Tl_Name);
    const dataToSend = { ...formData, Tl_Name: Tl_Name };

    fetch("http://localhost:5000/api/p_card_all_data", {
      method: "POST",
      headers: {
...
export default PartnerTlCardAddLeadForm;
