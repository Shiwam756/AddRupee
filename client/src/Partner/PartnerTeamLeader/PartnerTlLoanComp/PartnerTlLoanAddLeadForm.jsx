...
const PartnerTlLoanAddLeadForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const employeeEmail = localStorage.getItem("Tl_Name");

    console.log(employeeEmail);
    const dataToSend = { ...formData, Tl_Name: employeeEmail };

    fetch("http://localhost:5000/api/p_all_data", {
      method: "POST",
      headers: {
...
export default PartnerTlLoanAddLeadForm;
